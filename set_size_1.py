"""Script to set the Windows mouse pointer size to 1."""
...
winreg.SetValueEx(key, "CursorSize", 0, winreg.REG_DWORD, 1)
winreg.CloseKey(key)
...
# Size 1 -> 32
key2 = winreg.OpenKey(
    winreg.HKEY_CURRENT_USER, r"Control Panel\Cursors", 0, winreg.KEY_SET_VALUE
)
winreg.SetValueEx(key2, "CursorBaseSize", 0, winreg.REG_DWORD, 32)
...
ctypes.windll.user32.SystemParametersInfoW(
    SPI_SETCURSORSIZE, 0, 32, SPIF_UPDATEINIFILE | SPIF_SENDCHANGE
)
